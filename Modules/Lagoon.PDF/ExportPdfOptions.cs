...
/// <summary>
/// Options to be used in <see cref="IPuppeteerSharp.ExportUrlToPdf(string, ExportPdfOptions)"/>, <see cref="IPuppeteerSharp.ExportHtmlCodeToPdf(string, ExportPdfOptions)"/> and <see cref="Page.PdfDataAsync(PdfOptions)"/>
/// </summary>
public class ExportPdfOptions
{
    ...
    /// <summary>
    /// Paper format. A4 by default 
    /// </summary>
    public PaperFormatEnum Format { get; set; }

    /// <summary>
    /// Paper margins, defaults to none
    /// </summary>
    public PdfMarginOptions MarginOptions { get; set; } = new PdfMarginOptions();
