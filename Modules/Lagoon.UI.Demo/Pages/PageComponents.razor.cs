...
[AllowAnonymous]
[Route(ROUTE)]
public partial class PageComponents
{
    ...
    /// </summary>
    private const string ROUTE = "demo/components";
    ...
    {
        return new LgPageLink(ROUTE, "#sideTabStructureApp", IconNames.All.BorderOuter);
    }
