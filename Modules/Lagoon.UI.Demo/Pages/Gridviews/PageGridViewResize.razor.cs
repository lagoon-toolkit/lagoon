...
[Route(ROUTE)]
public partial class PageGridViewResize
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewResize";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Resize", IconNames.All.Grid1x2);
    }
