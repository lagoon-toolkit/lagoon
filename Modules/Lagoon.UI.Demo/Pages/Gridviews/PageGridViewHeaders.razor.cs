...
[Route(ROUTE)]
public partial class PageGridViewHeaders
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewHeaders";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Headers", IconNames.All.Grid1x2);
    }
