...
[Route(ROUTE)]
public partial class PageGridViewEditable
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewEdition";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Edition", IconNames.All.Grid1x2);
    }
    ...
    public int[] Pagination { get; } = new int[] { 10, 20, 50 };
