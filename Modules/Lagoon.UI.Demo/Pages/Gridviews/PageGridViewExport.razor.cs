...
[Route(ROUTE)]
public partial class PageGridViewExport
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewExport";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Export", IconNames.All.Grid1x2);
    }
    ...
    private List<string> ExportableColumns { get; set; } = new List<string>(){ "Id", "Name", "Surname", "Mail", "BirthDate" };
