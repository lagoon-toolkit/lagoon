...
[Route(ROUTE)]
public partial class PageGridViewSelection
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewSelection";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Selection", IconNames.All.Grid1x2);
    }
    ...
    {
        ShowSuccess("Row clicked");
    }

    private void MarkAsDone()
    {
        ShowInformation("Your items have been marked as read");
    }

    private void DeleteSelection()
    {
        ShowInformation("successful suppression");
    }
