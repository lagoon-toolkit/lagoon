...
[Route(ROUTE)]
public partial class PageGridViewGrouping
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewGrouping";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Grouping", IconNames.All.Grid1x2);
    }
