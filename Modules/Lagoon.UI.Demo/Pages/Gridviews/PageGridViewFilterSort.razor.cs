...
[Route(ROUTE)]
public partial class PageGridViewFilterSort
{
    ...
    /// </summary>
    private const string ROUTE = "demo/GridViewFilterSort";
    ...
    {
        return new LgPageLink(ROUTE, "GridView Filters & Sort", IconNames.All.Grid1x2);
    }
    ...
    private NumericFilter<int?> _defautFilter = new();
    ...
    protected override void OnInitialized()
    {
        ...
        _defautFilter.AddGreaterThan(60, true);
    ...
    private void FiltersVisibilityHasChanged(bool visible)
    {
        ShowInformation(String.Format("The line of filters is {0}", visible ? "visible" : "not visible"));
    }
