...
public partial class ProjectViewGroup<TItem> : ComponentBase where TItem : IWorkSchedulerData
{
    ...
    /// <summary>
    /// Shortcut for LgWorkScheduler GroupMargin
    /// </summary>
    private int GroupMargin => WorkScheduler.GroupMargin;
