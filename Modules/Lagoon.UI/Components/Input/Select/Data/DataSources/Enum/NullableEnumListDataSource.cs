...
public class NullableEnumListDataSource<TEnum> : EnumListDataSourceBase<TEnum, TEnum?> where TEnum : struct, Enum
{
    ...
    /// New instance.
    /// </summary>
    public NullableEnumListDataSource()
    {
    }
...
/* !!!!!!!!!!!! Don't activate this, prefer to promote the use of "DisplayAttribute".Order/Name ... */
    ...
    public NullableEnumListDataSource(bool sortByText = false, params TEnum[] ignoredValues) : base(sortByText, ignoredValues)
    {
    }
