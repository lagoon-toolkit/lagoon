...
public abstract class LgNotificationManagerGuid<TUser, TVmNotification, TNotification>
    : LgNotificationManagerBase<TUser, TVmNotification, TNotification, NotificationUserWithUserGuid<TNotification, TUser>, Guid>
    ...
    where TNotification : NotificationBase, new()
{
    ...
    public LgNotificationManagerGuid(ILgApplicationDbContext db, IHubContext<NotificationHub> hub)
        : base(db, hub, g => g)
    { }
